...
```{r, fig.cap="This shows the breakdown of clusterings, from Collection Object Type, to day of the week, then finally to the litter type."}
    ...
    time = ifelse(day=="Sunday", get_hour(time),
                  ifelse(day=="Monday", get_hour(time)+24,
                         ifelse(day=="Tuesday", get_hour(time)+48,
                                get_hour(time)+72))),
    closest_cent = paste("Collection ID:", closest_cent, sep=" ") # make centroid id prettier
  ) %>% 
